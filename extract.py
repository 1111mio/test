...
def extract_based_flow():
    config = {
        "run_mode": "flow",  
        "pcap_loc": r"C:\Users\Bomio\Downloads\trafficdet-main\trafficdet-main\data\pcap",
        "pcap_name": "2.pcapng",  
        "csv_path": r"C:/Users/Bomio\Downloads/trafficdet-main/trafficdet-main/data/featured_csv/2_statis.csv",
        "print_colname": True,  
        "read_all": False
    }
